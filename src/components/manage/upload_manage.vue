  ...
  <div class="user-message-main">
    <div class="show-message">
      <div class="show-div div-1">
        <div class="title-text">Upload File Number</div>
        <div class="middle-text">All accepted file <span class="active-num">{{acceptedFileNum}}</span></div>
        <div class="bottom-text">{{ uploadNum }}</div>
      </div>
      <div class="show-div div-1">
        <div class="title-text">Waiting to Check</div>
        <div class="middle-text">Check num today <span class="active-num">{{checkNum}}</span></div>
    ...
    <div class="upload-table">
      ...
      <el-table
        ...
        <el-table-column prop="uploadData" label="Upload Data" sortable></el-table-column>
        <el-table-column prop="description" label="Description"></el-table-column>
        <el-table-column prop="dataFiles" label="Data Files">
            <template slot-scope="scope">
                <el-button size="mini" @click="handleEdit(scope.$index, scope.row)">Download</el-button>
            </template>
        </el-table-column>
        <el-table-column prop="uploadTime" label="Upload Time" sortable></el-table-column>
        <el-table-column prop="status" label="Status"></el-table-column>
        <el-table-column  label="Operation">
            <template slot-scope="scope">
                <el-button size="mini" @click="handleEdit(scope.$index, scope.row)">Accept</el-button>
                <el-button size="mini" type="danger" @click="handleDelete(scope.$index, scope.row)" >Refuse</el-button>
            </template>
        </el-table-column>
      </el-table>
      <el-pagination
